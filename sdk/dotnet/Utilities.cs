...
namespace Pulumi.GoogleCloudStaticWebsite
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.GoogleCloudStaticWebsite.version.txt");
    ...
    internal sealed class GoogleCloudStaticWebsiteResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public GoogleCloudStaticWebsiteResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
